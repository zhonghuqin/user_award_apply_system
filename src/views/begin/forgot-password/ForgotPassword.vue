              ...
              <div class="right-box">
                ...
                <div >
                    ...
                    >
                        ...
                        >
                        <a-row>
                                <a-input-password class="input1" v-model:value="formState.password" placeholder="请输入新密码"/>
                        </a-row>
                        </a-form-item>
                        <a-form-item
                            name="repassword"
                        ...
                        >
                        <a-row>
                                <a-input-password class="input1" v-model:value="formState.repassword" placeholder="请再次输入密码"/>
                        </a-row>
                        </a-form-item>
                        <a-form-item
                            name="email"
