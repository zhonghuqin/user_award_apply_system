      ...
      <a-layout class="all-content">
        ...
        <a-col :span="12">
          <div class="right-content">
            <div class="right-box">
              <div class="change">
                  <a-switch  v-model:checked="state.checked" checked-children="登录" un-checked-children="注册" />
              </div>
              ...
              <div v-if="state.checked">
                  ...
                  >
                      ...
                      <a-form-item>
                      <a-button type="link" @click="forgotPassword" class="forget">忘记密码?点击此处</a-button>
                    </a-form-item>
                  </a-form>
              </div>
              <!-- 注册 -->
              <div v-else>
                <SelectMenu />
                  ...
                  >
                      ...
                      >
                          <a-row>
                                  <a-input class="input1" v-model:value="formState.useraccount" placeholder="请输入学号"/>
                          </a-row>
                      </a-form-item>
                      <a-form-item
                          name="username"
                          :rules="getUserValidationRules('姓名')"
                      >
                          <a-row>
                                  <a-input class="input1" v-model:value="formState.username" placeholder="请输入姓名"/>
                          </a-row>
                      </a-form-item>
                      <a-form-item
                          name="password"
                      ...
                      <a-form-item
                          name="email"
                          :rules="getEmeilValidationRules('邮箱')"
                      >
                      <a-row>
                              <a-input class="input1" v-model:value="formState.email" placeholder="请输入邮箱">
                                <template #addonAfter >
                                  <a-radio-button style="background-color: white;">发送验证码</a-radio-button>
                                </template>
                              </a-input>
                      </a-row>
                      </a-form-item>
                      <a-form-item
                          name="code"
                          :rules="getCodeValidationRules('验证码')"
                      >
                      <a-row>
                              <a-input class="input1" v-model:value="formState.code" placeholder="请输入邮箱验证码"/>

                      </a-row>
                      </a-form-item>
                  </a-form>
              </div>
              <a-button type="primary" v-if="state.checked" class="submit" @click="LogIn">登录</a-button>
              <a-button type="primary" v-else class="submit other" @click="signIn">注册</a-button>
          </div>
        </div>
        </a-col>
      </a-row>
